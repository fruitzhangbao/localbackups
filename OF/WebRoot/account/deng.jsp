...
<fieldset class="solid">
	<legend>登录</legend>
	<form action="${pageContext.request.contextPath}/account/deng/o" method="post">
	<div>
		<label>账号</label>
		<input type="text" name="account.name" value="${account.name}" />${nameMsg}${loginErrorMsg}
	</div>
	<div>
		<label>密码</label>
	...
	<div>
		<label>没有账号，可以点这里→<a href="${pageContext.request.contextPath}/account/join">注册</a></label>
	</div>
</fieldset>
